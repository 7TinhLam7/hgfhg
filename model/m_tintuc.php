...
class M_tintuc extends database{
    ...
    function getMenu(){
        ...
        tt.TieuDe as TieuDeTin, tt.Hinh as HinhTin, tt.Tomtat as TomTatTin, tt.TieuDeKhongDau as TieuDeKhongDauTin
        FROM theloai tl INNER JOIN loaitin lt ON lt.idTheLoai = tl.id INNER JOIN tintuc tt ON tt.idLoaiTin = lt.id GROUP BY tl.id";
        $this -> setQuery($sql);
        return $this->loadAllRows();
    }
